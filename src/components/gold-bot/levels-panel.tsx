              ...
              <div className="grid grid-cols-4 gap-1.5 text-center text-[11px]">
                {[
                  ...
                  <div key={label as string} className="rounded-lg bg-zinc-900/70 border border-zinc-800 py-2">
                    <div className="text-zinc-400 font-medium">{label as string}</div>
            ...
            <CardContent>
              <div className="grid grid-cols-5 gap-1.5 text-center">
                {signal.fib.levels.map((l) => (
                  ...
                  >
                    <div className="text-[10px] text-zinc-300">{(l.ratio * 100).toFixed(1)}%</div>
                    <div
                      className={cn(
        ...
        {signal.asianRange && (
          <Card className="border-zinc-800 bg-[#101013]">
            ...
            <CardContent className="flex flex-wrap gap-2 text-xs">
              ...
              <p className="text-[11px] text-zinc-300 w-full leading-relaxed">
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-1">
        {levels.length === 0 && <span className="text-xs text-zinc-400">لا مستويات قريبة</span>}
        {levels.map((l) => (
          <div
            key={`${l.price}-${l.label}`}
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-zinc-300">{l.label}</span>
            </div>
            <div className="flex items-center gap-1.5" dir="ltr">
              <span className="text-[10px] text-zinc-300">{l.touches}× لمسة</span>
